          ...
          <div className="text-center max-w-5xl">
            ...
            >
              <div className="relative">
                ...
                <div className="relative p-8 rounded-3xl glass-hover animate-float">
            ...
            >
              Segurança de{' '}
              <span className="glow-text">Classe Mundial</span>
              <br />
            ...
            >
              ...
              <Button
                ...
                className="px-8 py-6 text-lg glass-hover"
              >
                Ver Planos
              </Button>
              ...
              <Button
                ...
                variant="outline"
                onClick={() =>
                  window.open('https://discord.gg/X36RjdnReJ', '_blank')
                }
                className="px-8 py-6 text-lg glass-hover gap-2"
              >
